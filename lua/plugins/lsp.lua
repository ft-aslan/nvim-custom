	...
	dependencies = {
		...
		{ "hrsh7th/nvim-cmp", name = "cmp", dependencies = {
			...
			local cmp_mappings = require("lsp-zero").defaults.cmp_mappings({
				["<M-k>"] = require("cmp").mapping.select_prev_item(cmp_select),
				["<M-j>"] = require("cmp").mapping.select_next_item(cmp_select),
				["<M-i>"] = require("cmp").mapping.confirm({ select = true }),
